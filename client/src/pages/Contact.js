...
{/*           
      ...
      <h1 className="flfeatures">Our Team</h1>
      {/* <Row>
        <Col size="md-12">
...
<Col id="teamcol" size="md-4">
        ...
        <Col id="teamcol" size="md-4">
          ...
          <div className="membercopy"><p> <li>React Video Component</li><br /></p></div>
          <hr className="memberhr"/>
        </Col>
       <Col id="teamcol" size="md-4">
          ...
          <div className="membercopy"><p> <li>Work Out Table</li><br /></p></div>
          <hr className="memberhr"/>
        </Col>      
      </Row>
      {/* <Row>
